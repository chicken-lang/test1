...
// 数据源: useApi → /api/disclosure（SSR 预取）
const api = useApi()
const { data } = await useAsyncData('disclosure-directory', () => api.get<any[]>('/disclosure'))
const disclosureDirectory = computed(() => data.value ?? [])
